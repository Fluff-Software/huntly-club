...
import type { EnvironmentKey, EnvironmentProfile, GeneratorConfig, LatLon } from "./types.js";
 ...
 * Call only after a candidate has passed safety.
 * Dedupes by feature id so relation/member duplicates cannot double-count.
 */
export function scoreEnvironment(
  ...
  return profileTime("environment_ms", () => {
