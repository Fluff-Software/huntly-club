...
function transformActivity(activityData: any): Activity {
  return {
    ...
    prep_notif_title: activityData.prep_notif_title ?? null,
    prep_notif_description: activityData.prep_notif_description ?? null,
    remind_notif_title: activityData.remind_notif_title ?? null,
    remind_notif_description: activityData.remind_notif_description ?? null,
