/**
 * Overpass → GeoJSON conversion + small-bbox query builder for on-demand tiles.
 */
import type { Feature, FeatureCollection, Position } from "npm:@types/geojson@7946.0.16";
import type { OsmLikeProperties } from "./types.ts";
...
export function overpassToGeoJson(data: unknown): FeatureCollection {
...
/** Short-timeout Overpass query for a single tile / small bbox. */
export function buildOverpassQueryForBounds(bbox: BoundingBox): string {
