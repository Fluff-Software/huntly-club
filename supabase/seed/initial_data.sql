...
-- 4. One season
INSERT INTO public.seasons (name, hero_image, story) VALUES
  ('Spring 2025', 'https://via.placeholder.com/800x400/4CAF50/FFFFFF?text=Spring+2025', 'A season of growth and discovery. Get outside and explore your local nature.');

-- 5. Chapters for that season (unlock_date in the past so they appear unlocked)
INSERT INTO public.chapters (season_id, week_number, title, image, body, unlock_date) VALUES
  (1, 1, 'Welcome to the season', NULL, 'Start your journey with a few simple activities.', '2025-01-01'),
  (1, 2, 'Getting outdoors', NULL, 'Try bird spotting or a short exploration walk.', '2025-01-08'),
  (1, 3, 'Capture and collect', NULL, 'Use your camera or collect leaves and notice details.', '2025-01-15'),
  (1, 4, 'Sky and clouds', NULL, 'Spend some time cloud watching and relaxing outside.', '2025-01-22');
