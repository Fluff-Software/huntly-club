...
export const metadata: Metadata = {
  ...
  description:
    "Huntly World is built around seasons, chapters, and weekly outdoor missions for children aged 5–10. Here's exactly how the adventure club works.",
  openGraph: {
    title: "How Huntly World Works — Seasons, Chapters & Outdoor Missions",
    description:
      "Huntly World is built around seasons, chapters, and weekly outdoor missions for children aged 5–10. Here's exactly how the adventure club works.",
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Huntly World is designed for children aged 5–10. Younger children will need a grown-up to help with the app; older children can follow missions more independently.",
  },
];
