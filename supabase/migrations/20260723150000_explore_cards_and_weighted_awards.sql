...
INSERT INTO public.explore_cards (
  ...
  ('common-frog', 'Common Frog', 'A green-and-brown frog that loves damp places. Look for it near ponds — it hops away with long, strong back legs!', 'animal', 'uncommon', 'explore-cards/common-frog.png', 5,
    '{"freshwater":5,"wetland":4,"park_garden":2,"general":0.25}'::jsonb, 10),
  ('mallard', 'Mallard', 'A colourful duck you often see on ponds and lakes. The male has a shiny green head, and both love dabbling for food in the water.', 'animal', 'common', 'explore-cards/mallard.png', 10,
    '{"freshwater":5,"wetland":3,"park_garden":2,"general":0.25}'::jsonb, 20),
  ('dragonfly', 'Dragonfly', 'A speedy flyer with see-through wings. Dragonflies hunt tiny insects near water and can hover, dart, and turn in mid-air.', 'animal', 'common', 'explore-cards/dragonfly.png', 10,
    '{"freshwater":4,"wetland":4,"grassland":1,"general":0.25}'::jsonb, 30),
  ('pond-habitat', 'Pond Habitat', 'A still pool of fresh water full of life. Lily pads, reeds, frogs, and insects all share this peaceful watery world.', 'habitat', 'common', 'explore-cards/pond-habitat.png', 10,
    '{"freshwater":5,"wetland":3,"park_garden":1,"general":0.2}'::jsonb, 40),
  ('water-lily', 'Water Lily', 'A pretty flower that floats on the pond. Its big round leaves make perfect resting spots for frogs and insects.', 'flora_wildlife', 'uncommon', 'explore-cards/water-lily.png', 5,
    '{"freshwater":5,"wetland":2,"general":0.2}'::jsonb, 50),
  ('red-fox', 'Red Fox', 'A clever mammal with a rusty-red coat and a bushy white-tipped tail. Foxes roam woods and field edges, mostly at dusk.', 'animal', 'uncommon', 'explore-cards/red-fox.png', 5,
    '{"woodland":5,"farmland":2,"urban":1.5,"park_garden":2,"general":0.3}'::jsonb, 60),
  ('tawny-owl', 'Tawny Owl', 'A soft-feathered night hunter with big dark eyes. By day it rests in trees; by night it listens carefully for tiny rustles below.', 'animal', 'rare', 'explore-cards/tawny-owl.png', 6,
    '{"woodland":5,"park_garden":1,"general":0.2}'::jsonb, 70),
  ('oak-tree', 'Oak Tree', 'A mighty tree that can live for hundreds of years. Its wide branches and acorns feed birds, squirrels, and countless little bugs.', 'flora_wildlife', 'common', 'explore-cards/oak-tree.png', 10,
    '{"woodland":5,"park_garden":2,"general":0.25}'::jsonb, 80),
  ('woodland-habitat', 'Woodland Habitat', 'A shady world of trees, moss, and leaf litter. Paths and streams wind through the woods — perfect for quiet exploring.', 'habitat', 'common', 'explore-cards/woodland-habitat.png', 10,
    '{"woodland":5,"general":0.2}'::jsonb, 90),
  ('house-sparrow', 'House Sparrow', 'A small, chatty bird that lives near people. Sparrows hop along walls and hedges, looking for seeds and crumbs.', 'animal', 'common', 'explore-cards/house-sparrow.png', 10,
    '{"urban":5,"park_garden":3,"farmland":1,"general":0.3}'::jsonb, 100),
  ('pigeon', 'Pigeon', 'A familiar town bird with soft grey feathers and a shiny neck. Pigeons are great at finding food in parks and streets.', 'animal', 'common', 'explore-cards/pigeon.png', 10,
    '{"urban":5,"park_garden":2,"general":0.3}'::jsonb, 110),
  ('urban-fox', 'Urban Fox', 'A fox that feels at home in towns. It slips through gardens and quiet streets at night, using its sharp nose to find leftovers.', 'animal', 'uncommon', 'explore-cards/urban-fox.png', 5,
    '{"urban":5,"park_garden":2,"general":0.25}'::jsonb, 120),
  ('town-habitat', 'Town Habitat', 'Streets, gardens, walls, and little green corners. Towns may look busy, but birds, bugs, and clever foxes can still thrive here.', 'habitat', 'common', 'explore-cards/town-habitat.png', 10,
    '{"urban":5,"general":0.25}'::jsonb, 130),
  ('rabbit', 'Rabbit', 'A soft, twitchy-nosed grazer with long ears. Rabbits nibble grass and flowers, then hop to safety when they sense danger.', 'animal', 'common', 'explore-cards/rabbit.png', 10,
    '{"grassland":5,"farmland":3,"park_garden":3,"general":0.25}'::jsonb, 140),
  ('bumblebee', 'Bumblebee', 'A fuzzy, buzzing helper covered in soft hair. Bumblebees visit flowers for nectar and help plants make seeds and fruit.', 'animal', 'common', 'explore-cards/bumblebee.png', 10,
    '{"grassland":4,"park_garden":4,"farmland":2,"general":0.3}'::jsonb, 150),
  ('daisy', 'Daisy', 'A cheerful flower with white petals and a sunny yellow centre. Daisies love open grassy places where the light is bright.', 'flora_wildlife', 'common', 'explore-cards/daisy.png', 10,
    '{"grassland":4,"park_garden":4,"general":0.3}'::jsonb, 160),
  ('meadow-habitat', 'Meadow Habitat', 'A wide, open grassy place full of wildflowers. Bees, butterflies, and small animals love meadows buzzing with life.', 'habitat', 'uncommon', 'explore-cards/meadow-habitat.png', 5,
    '{"grassland":5,"farmland":2,"general":0.2}'::jsonb, 170),
  ('park-habitat', 'Park Habitat', 'A green space made for people and wildlife. Trees, lawns, and flower beds give birds and bugs places to rest and feed.', 'habitat', 'common', 'explore-cards/park-habitat.png', 10,
    '{"park_garden":5,"urban":2,"general":0.25}'::jsonb, 180),
  ('otter', 'Otter', 'A sleek river hunter with waterproof fur and webbed feet. Otters are shy — spotting one is a very special surprise!', 'animal', 'very_rare', 'explore-cards/otter.png', 3,
    '{"freshwater":5,"wetland":3,"general":0.15}'::jsonb, 190),
  ('kingfisher', 'Kingfisher', 'A tiny bird with dazzling blue-and-orange feathers. It perches by rivers, then dives like an arrow to catch small fish.', 'animal', 'rare', 'explore-cards/kingfisher.png', 6,
