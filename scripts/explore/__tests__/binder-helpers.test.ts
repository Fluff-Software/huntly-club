/**
 * Binder pagination/filter helpers live in apps/mobile (Step 9).
 * Mobile Jest (jest-expo) is currently blocked (missing expo-modules-core),
 * so these pure helpers are exercised here with Vitest.
 */
...
} from "../../../apps/mobile/utils/exploreBinder.ts";
...
describe("explore binder helpers (Step 9)", () => {
