...
-- Add foreign key to user_activity_progress
ALTER TABLE "public"."user_activity_photos" ADD CONSTRAINT "user_activity_photos_user_activity_id_fkey" FOREIGN KEY ("user_activity_id") REFERENCES "public"."user_activity_progress" ("id") ON DELETE CASCADE;
